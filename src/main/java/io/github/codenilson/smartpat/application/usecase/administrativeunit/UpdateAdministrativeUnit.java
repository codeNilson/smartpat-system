...
public class UpdateAdministrativeUnit {
    private final AdministrativeUnitRepository repository;

    @Inject
    public UpdateAdministrativeUnit(AdministrativeUnitRepository administrativeUnitRepository) {
        this.repository = administrativeUnitRepository;
    }

    public void execute(AdministrativeUnit administrativeUnit) {
        repository.update(administrativeUnit);
    }
}
